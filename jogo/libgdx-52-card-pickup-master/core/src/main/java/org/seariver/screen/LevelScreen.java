...
public class LevelScreen extends BaseScreen {
    ...
    public static float tempofacil;

    public LevelScreen(int MAXTEMPO) {
        super(MAXTEMPO);
    }
    ...
    public void initialize() {
        ...
        background.loadTexture("facil.png");
