...
public class LevelScreenMedio extends BaseScreen {

    private ArrayList<Pile> pileList;
    private Label messageLabel;
    public static float tempomedio;

    public LevelScreenMedio(int MAXTEMPO) {
        super(MAXTEMPO);
    }
    ...
    public void initialize() {
        ...
        background.loadTexture("medio.png");
